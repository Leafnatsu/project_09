...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Menu</h4>
   <a href="/admin/menu/from" class="btn btn-primary"> 
     
    ปุ่มเพิ่ม

      </a>
      <a href="/admin/menu/edit" class="btn btn-warning"> 
