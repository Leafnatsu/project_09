                  ...
                  <div class="card mb-6">
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <div class="input-group">
                        <form action="{{ route('adminpage.about.update',$about->id) }}" method="post"enctype="multipart/form-data">
                          @csrf
                        <input
                          type="text"
                          class="form-control"
                      ...
                      <h5>Image</h5>
                      <div class="input-group">
                        <input type="file" name="image" value="{{$about->image}}" class="form-control" id="inputGroupFile02" />
